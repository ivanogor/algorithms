public class ElevenTask {
    public static void main(String[] args) {
        ...
        int maxProduct = getMaxProduct(grid);

        System.out.println("Наибольшее произведение четырех подряд идущих чисел: " + maxProduct);
    }

    private static int getMaxProduct(int[][] grid) {
        int maxProduct = 0;
